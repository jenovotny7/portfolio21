...
function Resume() {
  // an array of two objecs that will be mapped to create the front and back end skill cards
    const skills = [{name: "Front-end",  skillset: ["HTML", "CSS", "JavaScript", "Bootstrap", "React", "React Bootstrap"]}, {name: "Back-end", skillset: ["Node.js", "Express.js", "MySQL", "MongoDB", "Mongoose", "MongoDB Atlas"]}]
  return (
    <section>
